...
public class DateAdapter extends BaseAdapter {
    ...
    public DateAdapter(Context context,int year,int month,String username){
        this.context=context;
        current_year=year;
        current_mon=month;
        helper=new SignInHelper(context);
        signIns=helper.query(username,year,month);
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            view = LayoutInflater.from(context).inflate(R.layout.calendar_item,null);
    ...
    public void signIn(OnSignListener listener){
        String username=context.getSharedPreferences("filter",Context.MODE_PRIVATE).getString("username","");
        helper.insert(DateUtil.current,username);
