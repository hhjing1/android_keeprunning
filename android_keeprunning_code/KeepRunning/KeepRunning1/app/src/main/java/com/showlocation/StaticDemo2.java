 ...
 * author zhh
 */
public class StaticDemo2 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // 地图初始化
        setContentView(R.layout.activity_sta2);
...
//		}
        ...
        String[] ll = wen.split(",");
        Toast.makeText(StaticDemo2.this,"初始化完成",Toast.LENGTH_SHORT).show();
        CoordinateConverter converter  = new CoordinateConverter();
        converter.from(CoordType.COMMON);
        double lanSum = 0;
        double lonSum = 0;
        System.out.println(Double.valueOf(ll[0]));
        Toast.makeText(StaticDemo2.this,String.valueOf(Double.valueOf(ll[0])),Toast.LENGTH_SHORT).show();
